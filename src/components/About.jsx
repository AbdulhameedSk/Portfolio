import aboutImg from "../assets/aboutpfpr.png";
  ...
  return (
    <div className="border-b border-neutral-900 pb-4">
      ...
      <div className="flex flex-wrap">
        ...
        <motion.div whileInView={{opacity:1,x:0}} initial={{opacity:0,x:100}} transition={{duration:1}} className="w-full lg:w-1/2 py-28">
