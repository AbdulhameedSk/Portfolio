...
export const EXPERIENCES = [
  {
    ...
    company: "Chauwk",
    description: `Led a team in developing and maintaining web and mobile applications using JavaScript, React.js, and Node.js. Implemented RESTful APIs and integrated with MongoDB databases. Collaborated with stakeholders to define project requirements and timelines.`,
    technologies: ["MongoDB", "ExoressJS", "ReactJS", "Postgres","Flutter","Figma"],
  },
  {
    ...
    technologies: ["MongoDB", "ExoressJS", "ReactJS", "Postgres"],
  },
];
